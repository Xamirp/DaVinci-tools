...
- 💾 **Экспорт и интеграция**:
  - **Экспорт в Final Cut Pro 7 XML (`.xml`)**: генерация стандартного XML со скомпилированным аудиофайлом и маркерами на клипе/таймлайне. Идеально для импорта в **Adobe Premiere Pro** и **Final Cut Pro 7**.
...
- **DaVinci Resolve Studio**: протестировано на **DaVinci Resolve Studio 21.0.2.4** (совместимо с версиями 18, 19, 20, 21+) — прямое управление маркерами через API.
