...
- 💾 **Экспорт и интеграция**:
  - **Экспорт в Final Cut Pro 7 XML (`.xml`)**: генерация стандартного XML со скомпилированным аудиофайлом и маркерами на клипе или таймлайне для импорта в DaVinci Resolve, Adobe Premiere Pro, Final Cut Pro.
  - Сохранение рассчитанных таймингов и долей в JSON (`music-beats.json`).
